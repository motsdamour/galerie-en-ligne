...
export default function ParametresPage() {
  ...
  const fieldLabel: React.CSSProperties = {
    fontSize: 10.5, fontWeight: 600, color: '#9B9B9B', fontFamily: "'Inter', sans-serif",
  ...
  const fieldBox: React.CSSProperties = {
    ...
    background: '#FAFAF8', border: '1px solid #E8E4DF', borderRadius: 10,
    ...
    <div style={{ padding: '0 36px 36px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 24, maxWidth: 600 }}>
        <div style={card}>
          ...
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 12, color: '#9B9B9B', marginBottom: 8, margin: '0 0 8px 0' }}>
